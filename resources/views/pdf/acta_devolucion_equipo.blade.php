...
<div class="container">
    ...
    <div class="doc-title">Acta de Devolución de Equipo</div>
    ...
    <div class="paragraph">
        Mediante el presente documento se deja constancia formal de la devolución del equipo descrito anteriormente. 
        El usuario que entrega declara que el equipo se encuentra en las condiciones registradas y el usuario que recibe 
        asume la responsabilidad correspondiente a partir de la fecha indicada.
    </div>
