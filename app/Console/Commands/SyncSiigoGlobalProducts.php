...
class SyncSiigoGlobalProducts extends Command
{
     ...
     * @var string
     */
    protected $signature = 'siigo:sync-products-global {--page= : Página específica de Siigo}';
     ...
     * Ejecutar el comando.
     */
    public function handle(SiigoGlobalService $siigoService)
    {
