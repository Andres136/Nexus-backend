...
class StoreCorporateDocumentRequest extends FormRequest
{
    ...
    {
        return [
            'slug' => 'nullable|string|max:120|unique:corporate_documents,slug',
    ...
    public function messages(): array
    {
        return [
            ...
            'file.max' => 'The file may not be greater than 30 MB.',
