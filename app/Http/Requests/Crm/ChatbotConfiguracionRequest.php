...
class ChatbotConfiguracionRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'sitio_web_productos_url' => 'nullable|url:http,https|max:500',
            'contexto_comercial' => 'nullable|string|max:8000',
    ...
    public function messages(): array
    {
        return [
            ...
            'sitio_web_productos_url.url' => 'La dirección de productos debe comenzar por http:// o https://.',
